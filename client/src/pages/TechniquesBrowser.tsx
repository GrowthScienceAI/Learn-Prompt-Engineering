      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {promptEngineeringTechniques.map((technique) => (
            <Card key={technique.id} className="hover:shadow-lg transition-shadow border-2 hover:border-blue-300">
              <CardHeader>
        ...
        {/* CTA */}
        <div className="mt-12 text-center bg-white rounded-xl p-8 border-2 border-blue-200">
