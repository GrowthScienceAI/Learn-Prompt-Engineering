  ...
  theme: {
    extend: {
      colors: {
        ...
        "colordark-grey": "var(--colordark-grey)",
        ...
        "colorwhite-grey": "var(--colorwhite-grey)",
      ...
      fontFamily: {
        a: "var(--a-font-family)",
        "a-2": "var(--a-2-font-family)",
        a2: "var(--a2-font-family)",
        h1: "var(--h1-font-family)",
        "h1-large": "var(--h1-large-font-family)",
